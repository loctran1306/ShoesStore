...
import ShoesItemTopSell from '../../components/shoesItem/ShoesItemTopSell';
...
export default function ShoesTopSell() {
  return (
    <Container
      sx={{
        py: { xs: 5, md: 8 },
    ...
    >
      ...
      >
        <ShoesItemTopSell variant="large" shoes={_shoesTopSell[0]} />
        ...
        >
          <ShoesItemTopSell shoes={_shoesTopSell[1]} />
          <ShoesItemTopSell shoes={_shoesTopSell[2]} />
        </Box>
      </Box>
    </Container>
  );
