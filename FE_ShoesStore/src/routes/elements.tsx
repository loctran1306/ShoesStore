...
// SHOSE_STORE
export const ShoesHomePage = Loadable(lazy(() => import('../pages/shoes/ShoesHomePage')));
export const AccountPage = Loadable(lazy(() => import('../pages/shoes/account/AccountPage')));
export const AuthLogin = Loadable(lazy(() => import('../pages/shoes/auth/AuthLogin')));
export const AuthRegister = Loadable(lazy(() => import('../pages/shoes/auth/AuthRegister')));
